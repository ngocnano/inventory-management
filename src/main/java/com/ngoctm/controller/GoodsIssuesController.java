...
@Controller
@RequestMapping("/stock/goods-issue")
public class GoodsIssuesController {

    static final Logger logger = Logger.getLogger(GoodsIssuesController.class);
    @Autowired
    ...
    public String redirect(){
        ...
        return "redirect:/stock/goods-issue/list/1";
    }
    ...
    public String addInvoice(Model model){
        ...
        return "stock/goods-issue-action";
    }

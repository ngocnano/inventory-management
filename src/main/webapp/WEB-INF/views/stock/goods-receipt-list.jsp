	...
	<div class="">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content">
					<a href="<c:url value="/stock/goods-receipt/add"/>" class="btn btn-app"><i class="fa fa-plus"></i>Add</a>
					<div class="container" style="padding: 50px;">
						<form:form modelAttribute="searchForm" cssClass="form-horizontal form-label-left" servletRelativeAction="/goods-receipt/list/1" method="POST">
							...
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="code">Product Name </label>
								<div class="col-md-6 col-sm-6 col-xs-12">
						...
						<table class="table table-striped jambo_table bulk_action">
							...
							<tbody>
								<c:forEach items="${invoices}" var="invoice" varStatus="loop">
									...
									<td class="text-center"><a href="<c:url value="/stock/goods-receipt/add/${invoice.id }"/>" class="btn btn-round btn-default">View</a></td>
									<td class="text-center"><a href="<c:url value="/stock/goods-receipt/edit/${invoice.id }"/>" class="btn btn-round btn-primary">Edit</a></td>
...
<script type="text/javascript">
	 function confirmDelete(id){
		 if(confirm('Do you want delete this record?')){
			 window.location.href = '<c:url value="/stock/goods-receipt/delete/"/>'+id;
		 }
	 }
	 function gotoPage(page){
		 $('#searchForm').attr('action','<c:url value="/stock/goods-receipt/list/"/>'+page);
		 $('#searchForm').submit();
	 }

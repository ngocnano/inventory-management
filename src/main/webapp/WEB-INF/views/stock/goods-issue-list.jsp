	...
	<div class="">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content">
					<a href="<c:url value="/stock/goods-issue/add"/>" class="btn btn-app"><i class="fa fa-plus"></i>Add</a>
						...
						<table class="table table-striped jambo_table bulk_action">
							...
							<tbody>
								<c:forEach items="${invoices}" var="invoice" varStatus="loop">
									...
									<td class="text-center"><a href="<c:url value="/stock/goods-issue/add/${invoice.id }"/>" class="btn btn-round btn-default">View</a></td>
									<td class="text-center"><a href="<c:url value="/stock/goods-issue/edit/${invoice.id }"/>" class="btn btn-round btn-primary">Edit</a></td>
...
<script type="text/javascript">
	 function confirmDelete(id){
		 if(confirm('Do you want delete this record?')){
			 window.location.href = '<c:url value="/stock/goods-issue/delete/"/>'+id;
		 }
	 }
	 function gotoPage(page){
		 $('#searchForm').attr('action','<c:url value="/stock/goods-issue/list/"/>'+page);
		 $('#searchForm').submit();
	 }

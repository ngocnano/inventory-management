		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						<br />
						<form:form modelAttribute="modelForm" cssClass="form-horizontal form-label-left" servletRelativeAction="/stock/goods-receipt/save" method="POST">
							<form:hidden path="id" />
							...
							<div class="form-group">
								...
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="productInfo.id">Product <span class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">

											<form:select path="productInfo.id" cssClass="form-control">
												<form:options items="${mapProduct}" />
											</form:select>
											<div class="has-error">
												<form:errors path="productInfo.id" cssClass="help-block"></form:errors>
											</div>
								</div>
...
<script type="text/javascript">
	...
	function cancel() {
		window.location.href = '<c:url value="/stock/goods-receipt/list"/>'
	}
</script>
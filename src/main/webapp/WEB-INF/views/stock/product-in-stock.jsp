            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="container" style="padding: 50px;">
                        <form:form modelAttribute="searchForm" cssClass="form-horizontal form-label-left" servletRelativeAction="/stock/product-in-stock/list/1" method="POST">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody>
                            <c:forEach items="${productInStockList}" var="product" varStatus="loop">

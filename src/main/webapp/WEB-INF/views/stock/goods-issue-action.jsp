		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						<br />
						<form:form modelAttribute="modelForm" cssClass="form-horizontal form-label-left" servletRelativeAction="/stock/goods-issue/save" method="POST">
							<form:hidden path="id" />
...
<script type="text/javascript">
	...
	function cancel() {
		window.location.href = '<c:url value="/stock/goods-issue/list"/>'
	}
</script>